...
frame = Frame(window, width = 312, height = 50, bg = "black", bd = 0, highlightbackground = "black", highlightcolor = "black", highlightthickness = 1)
frame.pack() #frame.pack(side = TOP)

# creating a input field inside the "Frame"
input_field = Entry(frame, font = ('arial', 16), textvariable = input_text, width = 20, bg = "#eee", bd = 0, justify = LEFT) #show = "*"
...
output_field = Entry(frame, font = ('arial', 16), textvariable = output_text, width = 20, bg = "#eee", bd = 0, justify = LEFT)
...
# first key
key1 = Entry(frame, font = ('arial', 12), textvariable = key1_text, width = 10, bg = "#eee", bd = 0, justify = LEFT)
key1.grid(row = 2, column = 0, columnspan = 1, padx = 1, pady = 1, sticky = W)
key1.insert(0, "0")

# second key
key2 = Entry(frame, font = ('arial', 12), textvariable = key2_text, width = 10, bg = "#eee", bd = 0, justify = LEFT)
key2.grid(row = 2, column = 1, columnspan = 1, padx = 1, pady = 1, sticky = W)
key2.insert(0, "0")

# third key
key3 = Entry(frame, font = ('arial', 12), textvariable = key3_text, width = 10, bg = "#eee", bd = 0, justify = LEFT)
key3.grid(row = 2, column = 2, columnspan = 1, padx = 1, pady = 1, sticky = W)
key3.insert(0, "0")

# buttons, all inside "frame"
clear = Button(frame, font = ('arial', 12), text = "clear", fg = "black", width = 30, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_clear()).grid(row = 3, column = 0, columnspan = 3, padx = 1, pady = 1, sticky = W+E)
encode = Button(frame, font = ('arial', 12), text = "encode", fg = "black", width = 30, height = 1, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_encode()).grid(row = 4, column = 0, columnspan = 3, padx = 1, pady = 0, sticky = W+E)
decode = Button(frame, font = ('arial', 12), text = "decode", fg = "black", width = 30, height = 1, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_decode()).grid(row = 5, column = 0, columnspan = 3, padx = 1, pady = 1, sticky = W+E)
